...
@Component({
  selector: 'app-edit-projectpm',
  templateUrl: './edit-projectpm.component.html',
  styleUrls: ['./edit-projectpm.component.css']
})
export class EditProjectpmComponent {
  projectId:string=""
  Technology =""
  ProjectTitle=""
  FrontEnd="" 
  ...
  constructor(private router:Router,private ar:ActivatedRoute,private projectService:ProjectuserService,private ts:ToastrService)
  {
